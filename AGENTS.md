...
This is the root agent-facing map. Nested `AGENTS.md` files are child maps, linked from their parent. Keep all guidance rooted in this tree. Vendor entry points are pointer shims, never a second rulebook.
