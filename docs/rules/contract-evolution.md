...
Implement one complete contract. Do not leave TODO implementations, no-op substitutes, compatibility shims, deprecated aliases, parallel V2 paths, policy-only placeholders, or comments promising later cleanup.
